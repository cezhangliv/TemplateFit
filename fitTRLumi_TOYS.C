...
#include "/path/to/the/directory/of/mue/code/MuEtree.h"//include the header file of the MuEtree class, which is needed to read some mesmer info (number of events, wnorm etc) from the results.root file
...
void fitTRLumi_TOYS(Double_t cutThetae_low = 0, Double_t cutThetae_high = 32, Double_t cutThetamu_low = 0.2, Double_t cutThetamu_high = 6) {
	...
	TString dir = "~/Scrivania/MUonE/Analysis/mue/test/"+job+"/results.root";
	...
	Double_t sigma0_tot  = MuEparams->Wnorm;//ub (Wnorm from NLO file)
